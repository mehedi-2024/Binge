...
export default function HorizontalVideoSlider() {
    return (
        <Marquee speed={40} gradient={false} pauseOnHover className="z-0">
            {allVideos.map((src, idx) => (
                <div
                    key={idx}
                    className="mx-4 w-[352px] h-[212px] aspect-video flex-shrink-0 overflow-hidden rounded-xl shadow relative group cursor-pointer"
                >
